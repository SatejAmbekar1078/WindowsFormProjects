<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EntityFW.Pages.Default" %>
        ...
        <div class="container">
            ...
            <div id="Grid" runat="server" visible="true">
                <asp:GridView ID="gvEmployees" runat="server" DataKeyNames="emp_id" AutoGenerateColumns="False"
                    ...
                    OnRowCancelingEdit="gvEmployees_RowCancelingEdit" CssClass="table table-striped">
                    <Columns>
                        <asp:BoundField DataField="emp_id" HeaderText="Employee ID" ReadOnly="True" />
                        <asp:BoundField DataField="Emp_name" HeaderText="Name" />
                        <asp:TemplateField HeaderText="Date of Birth">
                            <ItemTemplate>
                                <asp:Label ID="lblDOB" runat="server" Text='<%# Bind("DOB", "{0:yyyy-MM-dd}") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
